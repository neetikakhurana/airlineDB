...
<?php 		
	...
	if (!isset($_SESSION['adult_count1'])){
		$_SESSION['adult_count1']=1;
	}
	if (!isset($_SESSION['adult_count'])){
				...
				<div class="column column1">
					...
					<div class="content" id="email">
						<div>
							...
							<input type="email" name="first_name" value="<?php echo $_SESSION['login_user'];?>" id="first_name" placeholder="First Name" data-trigger="change" data-validation-minlength="1" data-type="name" data-required="true" data-error-message="Enter Your First Name"/>
						</div>		
					</div>
					...
					<form action="confirm.php" method="post" id="form1" style="background: rgba(3, 3, 3, 0.0);">
						...
						<div>
							...
							<div>
								...
								<input type="phone" name="telephone"  id="telephone" pattern="[0-9]*" title="Enter passport number in numerals" data-trigger="change" data-validation-minlength="1" data-type="number" data-required="true" data-error-message="Enter Your Telephone Number" required="required"/>
							</div>
							<div>
								<label for="passport" class="mycolor">Passport</label>
								<input type="text" name="passport"  id="passport" pattern="[0-9]*" title="Enter passport number in numerals" placeholder="Enter passport No" data-trigger="change" data-validation-minlength="1" required="required"/>
							</div>
						</div>
						<?php
							/*if ($_SESSION['adult_count']>1){
								echo '							<div>
								<label for="first_name" class="mycolor">Passenger Name</label>
								<input type="name" name="first_name" value="<?php echo $_SESSION['fname'];?>&nbsp;<?php echo $_SESSION['lname'];?>" id="first_name" placeholder="First Name" data-trigger="change" data-validation-minlength="1" data-type="name" data-required="true" data-error-message="Enter Your First Name"/>
							</div>
						...
						<div class="left" id="ordered">
							...
							<div class="totals" style="color:white;">
								<span class="subtitle " style="color:white;">Subtotal 
									<span id="sub_price">
										$<?php echo ($_POST['flight_price']*$_SESSION['adult_count1']);?>.00
									</span>
								</span>
								<span class="subtitle" style="color:white;">Tax <span id="sub_tax">$20.00</span></span>
							</div>
							<div class="final" style="color:white;">
								<span class="title">Total <span id="calculated_total">$<?php $price=($_POST['flight_price']*$_SESSION['adult_count']); echo $price+20;?>.00</span></span>
							</div>
						</div>	
